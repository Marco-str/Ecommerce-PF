    ...
    <div className={styles.mainContainer}>
      ...
      <div className={styles.productImg}>
        ...
        <div className={styles.img}>
          <img src={state.image} alt={state.name} className={styles.imgProducto} />
        </div>
        ...
        <div>
          ...
          <select type='select' name="color">
            ...
            {state?.color.map(e => {
              return (
                <option className={styles.color} name={e.ColorName} >{e.ColorName}</option>
              )
            })}
          </select>
          <div>
      ...
      <div className={styles.details}>
        ...
        <div className={styles.cart}>
          <button onClick={() => alert("En producción")}>Add to Cart <FaCartArrowDown className={styles.icon}></FaCartArrowDown></button>
          <NavLink to="/" >
            <button className={styles.bttnBack}>Back <FaArrowLeft className={styles.icon}></FaArrowLeft></button>
          </NavLink>
        </div>
      </div >
    </div >
